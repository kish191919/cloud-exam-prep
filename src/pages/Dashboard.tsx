...
const Dashboard = () => {
  ...
  const stats = [
    { icon: BookOpen, label: 'Exams Taken', value: submitted.length },
    ...
    <AppLayout>
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Welcome back! Track your certification progress.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
            ...
            <CardContent className="space-y-3">
              <Link to="/exams">
                <Button className="w-full justify-between bg-accent text-accent-foreground hover:bg-accent/90">
                  Start New Exam <ArrowRight className="h-4 w-4" />
                </Button>
              </Link>
              <Link to="/review">
                <Button variant="outline" className="w-full justify-between">
                  Review Wrong Answers <ArrowRight className="h-4 w-4" />
                </Button>
              </Link>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              {sessions.length === 0 ? (
                <p className="text-sm text-muted-foreground py-4 text-center">No exams taken yet. Start your first practice!</p>
              ) : (
