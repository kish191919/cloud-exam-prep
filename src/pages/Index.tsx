...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* 자격증 로드맵 CTA */}
      <section className="py-10 md:py-12 px-4 border-y border-primary/20 roadmap-cta-bg">
      ...
      {/* Features */}
      <section id="features" className="py-16 md:py-20 px-4 features-section-bg">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid sm:grid-cols-3 gap-5 md:gap-8">
            {routineSteps.map((step, i) => {
              ...
              return (
                <a key={i} href="https://cloudmasterit.com/exams" className="block rounded-2xl p-5 md:p-6 border border-primary/15 card-hover shadow-sm routine-card-bg">
      ...
      {/* How it works */}
      <section className="py-16 md:py-20 px-4 howitworks-section-bg">
        <div className="container mx-auto max-w-4xl">
