...
- ❌ 무관 단언 금지: `"XXX는 이 문제와 무관합니다."` 형식 → 왜 무관한지 이유를 1~2문장으로 설명해야 함
...
[PASS] 보기 해설 완결성: options 4개 모두 explanation 필드에 실질적 근거 1문장 이상 포함 — "정답입니다.", "오답입니다.", "Correct answer.", "이는 잘못된 정의입니다.", "순서가 잘못되었습니다.", "XXX는 이 문제와 무관합니다." 등 판정만 있는 문장 → FAIL
