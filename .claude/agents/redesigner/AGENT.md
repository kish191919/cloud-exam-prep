...
- **단락 1 — 문제 접근 & 정답 근거**: 이 문제에서 어떤 단서(키워드·조건)를 보고 정답을 선택해야 하는지 설명. 정답이 왜 맞는지 구체적 근거 포함. (2~4문장)
- **단락 2 — 개념 설명 & 실전 맥락**: 관련 AWS/클라우드 개념과 서비스 동작 원리를 교과서적으로 상세히 설명. 실제 사용 사례 또는 아키텍처 맥락 포함. (3~5문장)
- **단락 3 — 시험 포인트**: 시험에서 자주 나오는 함정, 혼동하기 쉬운 서비스 간 구분법, 핵심 키워드. 수험생이 주의해야 할 판단 기준 명시. (2~4문장)
