...
**규칙 G4** ref_links: 공식 문서 URL 2~5개. 빈 배열 금지. 각 링크에 name(한국어), name_en, name_pt, name_es, name_ja 포함 필수.
...
```json
{
  ...
  "result": {
    ...
    "read_time_minutes": 6,
    "ref_links": "[{\"name\": \"Amazon Bedrock 개발자 가이드\", \"name_en\": \"Amazon Bedrock Developer Guide\", \"name_pt\": \"Guia do Desenvolvedor Amazon Bedrock\", \"name_es\": \"Guía del Desarrollador Amazon Bedrock\", \"name_ja\": \"Amazon Bedrock 開発者ガイド\", \"url\": \"https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html\"}, {\"name\": \"Amazon Bedrock 파운데이션 모델\", \"name_en\": \"Amazon Bedrock Foundation Models\", \"name_pt\": \"Modelos de Base Amazon Bedrock\", \"name_es\": \"Modelos Base de Amazon Bedrock\", \"name_ja\": \"Amazon Bedrock 基盤モデル\", \"url\": \"https://docs.aws.amazon.com/bedrock/latest/userguide/models-features.html\"}]",
    "is_published": false
  }
}
```
